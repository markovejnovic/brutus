...
/* harmony default export */ __webpack_exports__["default"] = (DayMoment);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DayMoment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DayMoment */ "./src/DayMoment.js");

const TIME_START_TOO_BIG_ERROR = 'The specified startTime is larger than ' + 'timeStop.';
const TIME_STOP_TOO_SMALL_ERROR = 'The specified stopTime is smaller than ' + 'timeStart.';
/**
...
/* harmony default export */ __webpack_exports__["default"] = (TimePeriod);

/***/ }),

/***/ "./src/util/weekdays.js":
/*!******************************!*\
  !*** ./src/util/weekdays.js ***!
  \******************************/
/*! exports provided: compareWeekDays */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "compareWeekDays", function() { return compareWeekDays; });
...
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! chai */ "./node_modules/chai/index.js");
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(chai__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_DayMoment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/DayMoment */ "./src/DayMoment.js");
...
describe('DayMoment.seconds', function () {
  it('accepts positive and zero values.', function () {
    let m = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_1__["default"](0, 0, 0);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      m.seconds = 0;
    }).to.not.throw(RangeError, negativeValueError);
  });
  it('does not accept negative moments.', function () {
    let m = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_1__["default"](0, 0, 0);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      m.seconds = -1;
    }).to.throw(RangeError, negativeValueError);
  });
});
describe('DayMoment.getSeconds()', function () {
  it('calculates the number of seconds of a non-zero moment.', function () {
    let hourMoment = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_1__["default"](1, 2, 3);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(hourMoment.seconds).to.equal(3723);
  });
  it('calculates the number of seconds of a zero moment.', function () {
    let zeroMoment = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_1__["default"](0, 0, 0);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(zeroMoment.seconds).to.equal(0);
  });
});

/***/ }),

/***/ "./test/DayPeriod.test.js":
/*!********************************!*\
  !*** ./test/DayPeriod.test.js ***!
  \********************************/
/*! no exports provided */
...
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! chai */ "./node_modules/chai/index.js");
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(chai__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/DayPeriod */ "./src/DayPeriod.js");
/* harmony import */ var _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/DayMoment */ "./src/DayMoment.js");



describe('DayPeriod.length', function () {
  it('calculates the length between two DayMoments correctly in seconds', function () {
    let m1 = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0);
    let m2 = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](1, 2, 3);
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](m1, m2);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(p.length).to.equal(3723);
  });
});
describe('DayPeriod.timeStart', function () {
  it('accepts values smaller than timeStop', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 2));
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      p.timeStart = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 1);
    }).to.not.throw(RangeError, 'The specified startTime is larger than timeStop.');
  });
  it('does not accept values equal to or greater than timeStop.', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 2));
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      p.timeStart = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 3);
    }).to.throw(RangeError, 'The specified startTime is larger than timeStop.') && Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      p.timeStart = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 2);
    }).to.throw(RangeError, 'The specified startTime is larger than timeStop.');
  });
});
describe('DayPeriod.timeStop', function () {
  it('accepts values greater than timeStart', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 2), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 3));
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      p.timeStop = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 4);
    }).to.not.throw(RangeError, 'The specified stopTime is smaller than timeStart.');
  });
  it('does not accept values equal to or smaller than timeStart', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 2), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 3));
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      p.timeStop = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 1);
    }).to.throw(RangeError, 'The specified stopTime is smaller than timeStart.') && Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      p.timeStop = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 2);
    }).to.throw(RangeError, 'The specified stopTime is smaller than timeStart.');
  });
});
describe('DayPeriod.isMomentIn(moment)', function () {
  it('returns true when moment is in the period', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](48, 2, 60));
    let m = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](2, 4, 0);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(p.isMomentIn(m)).to.be.true;
  });
  it('returns false when the moment is not in the period', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 1));
    let m = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 3);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(p.isMomentIn(m)).to.be.false;
  });
  it('returns true when the moment is the same as the this.timeStart', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 1));
    let m = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(p.isMomentIn(m)).to.be.true;
  });
  it('returns true when the moment is the same as the this.timeStop', function () {
    let p = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 1));
    let m = new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 1);
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(p.isMomentIn(m)).to.be.true;
  });
});
describe('DayPeriod.conflicts(period)', function () {
  it('correctly checks when it conflicts with another TimePeriod', function () {
    let p1 = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](1, 2, 3));
    let p2 = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](0, 2, 3));
    let p3 = new _src_DayPeriod__WEBPACK_IMPORTED_MODULE_1__["default"](new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](2, 3, 0), new _src_DayMoment__WEBPACK_IMPORTED_MODULE_2__["default"](3, 0, 0));
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(p1.conflicts(p2) && p2.conflicts(p1)).to.be.true && Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(p1.conflicts(p3) && p3.conflicts(p1)).to.be.false;
  });
});

/***/ }),

/***/ "./test/WeeklyRepeatingPeriod.test.js":
/*!********************************************!*\
  !*** ./test/WeeklyRepeatingPeriod.test.js ***!
  \********************************************/
/*! no static exports found */
...
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! chai */ "./node_modules/chai/index.js");
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(chai__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_util_weekdays__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../src/util/weekdays */ "./src/util/weekdays.js");


describe('compareWeekDays(a, b)', function () {
  it('returns 1 for a > b', function () {
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(Object(_src_util_weekdays__WEBPACK_IMPORTED_MODULE_1__["compareWeekDays"])('tuesday', 'monday')).to.equal(1);
  });
  it('returns -1 for a < b', function () {
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(Object(_src_util_weekdays__WEBPACK_IMPORTED_MODULE_1__["compareWeekDays"])('monday', 'tuesday')).to.equal(-1);
  });
  it('returns 0 for a === b', function () {
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(Object(_src_util_weekdays__WEBPACK_IMPORTED_MODULE_1__["compareWeekDays"])('monday', 'monday')).to.equal(0);
  });
  ...
  it('throws an error when a day isn\'t properly written', function () {
    Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      Object(_src_util_weekdays__WEBPACK_IMPORTED_MODULE_1__["compareWeekDays"])('monday', 'tusday');
    }).to.throw(ReferenceError, 'Incorrectly spelled day.') && Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(() => {
      Object(_src_util_weekdays__WEBPACK_IMPORTED_MODULE_1__["compareWeekDays"])('mnday', 'tuesday');
    }).to.throw(ReferenceError, 'Incorrectly spelled day.');
  });
});
...
/***/ 0:
/*!*******************************************************************************************************************************************************!*\
  !*** multi ./test/Course.test.js ./test/DayMoment.test.js ./test/DayPeriod.test.js ./test/util/weekdays.test.js ./test/WeeklyRepeatingPeriod.test.js ***!
  \*******************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/marko/Desktop/brutus/test/Course.test.js */"./test/Course.test.js");
__webpack_require__(/*! /home/marko/Desktop/brutus/test/DayMoment.test.js */"./test/DayMoment.test.js");
__webpack_require__(/*! /home/marko/Desktop/brutus/test/DayPeriod.test.js */"./test/DayPeriod.test.js");
__webpack_require__(/*! /home/marko/Desktop/brutus/test/util/weekdays.test.js */"./test/util/weekdays.test.js");
module.exports = __webpack_require__(/*! /home/marko/Desktop/brutus/test/WeeklyRepeatingPeriod.test.js */"./test/WeeklyRepeatingPeriod.test.js");
